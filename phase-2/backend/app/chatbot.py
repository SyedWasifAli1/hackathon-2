...
agent = Agent(
   ...
   instructions=(
    ...
    "Always reply in a mix of Roman Urdu and simple English. "
    "If the user writes in English, respond in English. "
    "If the user writes in Roman Urdu or Urdu-style English, "
    "respond in Roman Urdu mixed with English. "
    "Match the user's language and tone naturally. "
    "Keep answers clear, polite, and easy to understand."
),  
    model=model,
)
